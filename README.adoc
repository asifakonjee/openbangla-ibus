...
মূলত এই রিপোজিটরিটির স্ক্রিপ্ট দ্বারা ibus এর সাথে ব্যবহারের জন্যে ওপেনবাংলা কিবোর্ড সহজে ইন্সটল করতে পারবেন।
...
```bash
bash -c "$(wget -q https://raw.githubusercontent.com/asifakonjee/openbangla-ibus/master/installer.sh -O -)"
```


== শেষ ধাপ

রিস্টার্ট করুন বা লগ আউট করে পুনরায় লগ ইন করুন। এবার https://github.com/OpenBangla/OpenBangla-Keyboard/wiki/Configuring-Environment লিংকে গিয়ে আপনার ডেস্কটপ এনভাইরনমেনন্ট অনুযায়ী ibus এ ওপেনবাংলা কিবোর্ড সেট আপ করে নিন। 
